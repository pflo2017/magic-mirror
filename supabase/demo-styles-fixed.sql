-- First, let's check what enum values exist and add the ones we need
-- Add enum values if they don't exist (this won't error if they already exist)
ALTER TYPE style_category ADD VALUE IF NOT EXISTS 'women_hairstyles';
ALTER TYPE style_category ADD VALUE IF NOT EXISTS 'women_colors';
ALTER TYPE style_category ADD VALUE IF NOT EXISTS 'men_hairstyles';
ALTER TYPE style_category ADD VALUE IF NOT EXISTS 'men_colors';
ALTER TYPE style_category ADD VALUE IF NOT EXISTS 'men_beards';
